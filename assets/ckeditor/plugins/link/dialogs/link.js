(function() {
	...
	function fixlinkname(filename) {
		var start = filename.lastIndexOf("(");
        var end = filename.lastIndexOf(")");
        if (start != "-1" && end != "-1") {
            filename = filename.slice(0,start);
        }
        return filename;                
	}
        ...
        return {
            ...
            contents: [{
                ...
                elements: [{
                    ...
                    setup: function() {
                        this.enable();
                        filename = c.getSelection().getSelectedText();
                        this.setValue(fixlinkname(filename));
                        q = this.getValue();
                    },
                    commit: function(a) {
                        a.linkText = this.isEnabled() ? c.getSelection().getSelectedText() : ""
                    }
                }, {
                    id: "linkType",
                    type: "select",
                    ...
                    onChange: function() {
                        var a = this.getDialog(),
                            ...
                            f = f && f.hidden;
                        "url" == r ? (c.config.linkShowTargetTab &&
                            a.showPage("target"), f || a.showPage("upload")) : (a.hidePage("target"), f || a.hidePage("upload"));
                    ...
                    children: [{
                        ...
                        children: [{
                            ...
                            onKeyUp: function() {
                                ...
                                f ? (this.setValue(b.substr(f[0].length)), a.setValue(f[0].toLowerCase())) : c.test(b) && a.setValue("");
                                this.allowOnChange = !0
                            },
                            onChange: function() {
                            ...
                            validate: function() {
                                var a = this.getDialog();
                                return a.getContentElement("info", "linkType") && "url" != a.getValueOf("info", "linkType") ? !0 : !c.config.linkJavaScriptLinksAllowed && /javascript\:/.test(this.getValue()) ? (alert(h.invalidValue), !1) : this.getDialog().fakeObj ? !0 : CKEDITOR.dialog.validate.notEmpty(b.noUrl).apply(this)
                            },
                            setup: function(a) {
                                this.allowOnChange = !1;
                                a.url && this.setValue(a.url.url);
                                //get value cua url
                                urlvalue = this.getDialog().getValueOf("info", "url");
                                //get value a.linkText
                                linkvalue = c.getSelection().getSelectedText();
                                var hu = this.getDialog().getContentElement("info","linkDisplayText");
                                //KT lan submit dau tien, neu van chua ton tai urlvalue thi gan a.linkText cho linkDisplayText
                              	if (!urlvalue || !getFileSize(urlvalue)) {
                              		hu.setValue(linkvalue);
                              	}
                                this.allowOnChange = !0
                            },
                            commit: function(a) {
                                ...
                                var hi = this.getDialog().getValueOf("info", "linkDisplayText");
                                //set value a.linkText khi ton tai url file
                                if (getFileSize(this.getValue())) {
                                	a.linkText = this.isEnabled() ? hi+"("+getFileSize(this.getValue())+"kb)" : "";
                                }else{
                                    a.linkText = " "+hi;
                                }
                                this.allowOnChange = !1
                        ...
                        children: [{
                            ...
                            children: [{
                                ...
                                setup: function(a) {
                                    ...
                                    this.add("");
                                    if (l)
                                        for (var b = 0; b < l.length; b++) l[b].name && this.add(l[b].name);
                                ...
                                setup: function(a) {
                                    ...
                                    this.add("");
                                    if (l)
                                        for (var b = 0; b < l.length; b++) l[b].id && this.add(l[b].id);
                ...
                elements: [{
                    ...
                    children: [{
                        ...
                        setup: function(a) {
                            a.target &&
                                this.setValue(a.target.type || "notSet");
                            t.call(this)
                        },
                        commit: function(a) {
                            a.target || (a.target = {});
            ...
            onShow: function() {
                var a = this.getParentEditor(),
                    ...
                    c = this.getContentElement("info",
                        "linkDisplayText").getElement().getParent().getParent(),
